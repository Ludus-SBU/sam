...
import make_initial_abundance_MESAhybrid
...
r  = make_initial_abundance_MESAhybrid.func_rad()
...
if r > 2.140619329540536E8:
        ...
        c12,ne20,ne22,o16,n14  = make_initial_abundance_MESAhybrid.func_shell(r)
        ...
        c12,ne20,ne22,o16  = make_initial_abundance_MESAhybrid.func_core(r)
